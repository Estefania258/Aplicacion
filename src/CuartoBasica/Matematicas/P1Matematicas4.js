...
import "./P1Matematicas4.css"; // Importamos el CSS externo

const P1Matematicas4 = ({ nextQuestion }) => {
  ...
  const handleCalificacion = (esCorrecta) => {
    ...
    localStorage.setItem("puntuacionM4_P1", JSON.stringify(resultado));
  ...
  return (
    <div className="background-container">
      <div className="question-container">
        ...
        <h4>Lectura y Dictado de numeración hasta el 99.999</h4>
